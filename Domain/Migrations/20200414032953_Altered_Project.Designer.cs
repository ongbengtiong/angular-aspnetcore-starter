...
namespace Domain.Migrations
{
    ...
    [Migration("20200414032953_Altered_Project")]
    partial class Altered_Project
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Core.Security.User", b =>
                {
            ...
            modelBuilder.Entity("DSO.DotnetCore.Domain.Entities.Order", b =>
                {
                    b.HasOne("Domain.Core.Security.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Domain.Core.Security.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
